    ...
    return (
        <div className="container">
            ...
            <section className="about-me-blurb">
                <p className='subtext'>Hello, I'm Dale, a Software Engineer based in Adelaide.</p>
                ...
                <p className='subtext'>If you require a dedicated and enthusiastic team member to contribute to your projects, I'm ready to collaborate and expand my expertise with you.</p>
            </section>
            <Stack>
